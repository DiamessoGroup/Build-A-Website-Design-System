...
Your style guide/design system will include at least a section on colors, fonts, and specific text styles, but it can be extended to as many other areas as you’d like. You can take a look at our [basic example](https://content.codecademy.com/PRO/independent-practice-projects/website-design-system/example/index.html) site for a taste of what you’ll be building (yours will be customized).

**Example**

![Website Style Guide Example](./resources/img/website-style-guide-example.png)
